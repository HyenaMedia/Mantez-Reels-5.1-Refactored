...
const Inspector = ({ onBack = null, backLabel = null }) => {
  ...
  if (!selectedElement && selectedSection && section) {
    return <SectionInspector section={section} updateSection={updateSection} setSelectedSection={setSelectedSection} onBack={onBack} backLabel={backLabel} />;
  }
...
const EffectsTab = ({ element, updateElement }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Field label={`Hue Rotate: ${effects.hueRotate ?? 0}°`}>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <NumberField label="Rotate (°)" value={transform.rotate ?? 0} min={-360} max={360}
          onChange={v => setTR('rotate', v)} />
        <NumberField label="Skew X (°)" value={transform.skewX ?? 0} min={-45} max={45}
...
const SectionInspector = ({ section, updateSection, setSelectedSection, onBack = null, backLabel = null }) => {
